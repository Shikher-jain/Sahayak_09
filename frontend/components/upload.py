...
def show_upload_ui():
    ...
    if upload_type == "PDF":
        ...
        if uploaded_file:
            ...
            pdf_ingestor.ingest_pdf(uploaded_file)
        ...
        if uploaded_file:
            ...
            image_ingestor.ingest_image(uploaded_file)
        ...
        if uploaded_file:
            ...
            audio_ingestor.ingest_audio(uploaded_file)
        ...
        if uploaded_file:
            ...
            video_ingestor.ingest_video(uploaded_file)
